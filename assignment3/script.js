...
const definitionName = 'column.gh'
...
angle_slider.addEventListener( 'input', onSliderChange, false )
const scale_slider = document.getElementById( 'Scale' )
scale_slider.addEventListener( 'input', onSliderChange, false )
const extrusion_slider = document.getElementById( 'Extrusion' )
extrusion_slider.addEventListener( 'input', onSliderChange, false )
...
async function compute() {
    ...
    let Angle = document.getElementById('Angle').valueAsNumber
    ...
    let param2 = new RhinoCompute.Grasshopper.DataTree('RH_IN:Angle')
    param2.append([0], [Angle])
    let param3 = new RhinoCompute.Grasshopper.DataTree('RH_IN:Scale')
    param3.append([0], [Scale])
    let param4 = new RhinoCompute.Grasshopper.DataTree('RH_IN:Extrusion')
